...
function draw() {
  ...
  if (pose) {
    ...
    for (let i = 0; i < skeleton.length; i++) {
      ...
      bezier(a.position.x*1.2+250, a.position.y,a.position.x*1.2 + random(50)+250, a.position.y+random(50),b.position.x*1.2+random(50)+250,b.position.x +random(50) , b.position.x*1.2+250, b.position.y);
