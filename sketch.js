...
function draw() {
  ...
  if (pose) {
    ...
    for (let i = 0; i < skeleton.length; i++) {
      ...
      bezier(a.position.x, a.position.y,a.position.x + random(50), a.position.y+random(50),b.position.x+random(50),b.position.x +random(50) , b.position.x, b.position.y);
